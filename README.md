...
| **📉 LangGraph** | Idea of creating stateful AI agents and multi-agent workflows. <br><sub>*Tech:* <kbd>langgraph</kbd> <kbd>StateGraph</kbd> <kbd>Annotated</kbd> <kbd>dataclass</kbd> <kbd>pydantic</kbd> |
